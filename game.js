...
function checkGuess () {
    ...
    // Update all keyboard keys at exact moment last tile's color is revealed (midpoint of flip)
    // Last tile starts at 350*4=1400ms, color reveals at halfway through 1200ms animation = +600ms
    setTimeout(() => {
        for (let i = 0; i < 5; i++) {
